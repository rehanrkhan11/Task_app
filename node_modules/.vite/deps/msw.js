...
async function parseQuery(query) {
  const { parse: parse3 } = await import("./graphql-7YOWDVOV.js").catch((error) => {
...
var _ServerSentEventHandler_instances, attachClientLogger_fn;
var ServerSentEventHandler = class extends HttpHandler {
  constructor(path, resolver) {
    ...
    super("GET", path, async (info) => {
      ...
      __privateMethod(this, _ServerSentEventHandler_instances, attachClientLogger_fn).call(this, info.request, clientEmitter);
...
var _encoder, _controller, _emitter, _ServerSentEventClient_instances, sendRetry_fn, sendMessage_fn;
var ServerSentEventClient = class {
  constructor(args) {
    ...
    __privateSet(this, _emitter, args.emitter);
  }
  /**
  ...
  error() {
    ...
    __privateGet(this, _emitter).emit("error");
  }
  /**
  ...
  close() {
    ...
    __privateGet(this, _emitter).emit("close");
  }
};
