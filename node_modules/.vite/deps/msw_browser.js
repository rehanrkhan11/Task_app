...
var WebSocketOverride = class extends EventTarget {
  ...
  send(data) {
    ...
    queueMicrotask(() => {
      var _a5;
      this.bufferedAmount = 0;
      (_a5 = this[kOnSend]) == null ? void 0 : _a5.call(this, data);
    });
  }
...
function enableMocking(context, options) {
  ...
  context.workerChannel.once("MOCKING_ENABLED", async (event) => {
    ...
    printStartMessage({
      quiet: options.quiet,
      workerScope: (_a5 = context.registration) == null ? void 0 : _a5.scope,
...
function getVariable(variableName) {
  ...
  return (_a5 = globalThis[variableName]) == null ? void 0 : _a5.toString();
}
...
var Interceptor2 = class {
  ...
  getInstance() {
    ...
    this.logger.info("retrieved global instance:", (_a5 = instance == null ? void 0 : instance.constructor) == null ? void 0 : _a5.name);
    return instance;
  }
  setInstance() {
...
var _FetchResponse = class extends Response {
  ...
  constructor(body, init = {}) {
    var _a5;
    const status = (_a5 = init.status) != null ? _a5 : 200;
...
function createResponseListener(context) {
  return (event) => {
    ...
    if ((_a5 = responseMessage.response.type) == null ? void 0 : _a5.includes("opaque")) {
      return;
    }
...
var _a2, _b, _c, _d, _returnType, _e;
var TypedEvent = (_e = class extends (_d = MessageEvent, _c = kDefaultPrevented2, _b = kPropagationStopped, _a2 = kImmediatePropagationStopped, _d) {
  constructor(...args) {
    super(args[0], args[1]);
    /**
...
}, _returnType = new WeakMap(), _e);
var kListenerOptions = Symbol("kListenerOptions");
var _listeners, _Emitter2_instances, addListener_fn, proxyEvent_fn, callListener_fn, _a3;
var Emitter2 = (_a3 = class {
  constructor() {
    __privateAdd(this, _Emitter2_instances);
  ...
  on(type, listener, options) {
    return __privateMethod(this, _Emitter2_instances, addListener_fn).call(this, type, listener, options);
  }
  /**
  ...
  earlyOn(type, listener, options) {
    return __privateMethod(this, _Emitter2_instances, addListener_fn).call(this, type, listener, options, "prepend");
  }
  /**
  ...
  emit(event) {
    ...
    const proxiedEvent = __privateMethod(this, _Emitter2_instances, proxyEvent_fn).call(this, event);
    for (const listener of __privateGet(this, _listeners)[event.type]) {
      ...
      __privateMethod(this, _Emitter2_instances, callListener_fn).call(this, proxiedEvent.event, listener);
    }
    proxiedEvent.revoke();
    return true;
  }
  ...
  async emitAsPromise(event) {
    ...
    for (const listener of __privateGet(this, _listeners)[event.type]) {
      ...
      pendingListeners.push(
        ...
        await Promise.resolve(__privateMethod(this, _Emitter2_instances, callListener_fn).call(this, proxiedEvent.event, listener))
      );
    }
    proxiedEvent.revoke();
  ...
  *emitAsGenerator(event) {
    ...
    for (const listener of __privateGet(this, _listeners)[event.type]) {
      ...
      yield __privateMethod(this, _Emitter2_instances, callListener_fn).call(this, proxiedEvent.event, listener);
    }
    proxiedEvent.revoke();
  }
  /**
  ...
  removeListener(type, listener) {
    ...
    const nextListeners = [];
    for (const existingListener of __privateGet(this, _listeners)[type]) {
      if (existingListener !== listener) {
        nextListeners.push(existingListener);
      }
    }
    __privateGet(this, _listeners)[type] = nextListeners;
  }
  /**
  ...
  listeners(type) {
    if (type == null) {
      return Object.values(__privateGet(this, _listeners)).flat();
    }
    return __privateGet(this, _listeners)[type] || [];
  }
  /**
...
}, _listeners = new WeakMap(), _Emitter2_instances = new WeakSet(), addListener_fn = function(type, listener, options, insertMode = "append") {
  var _a5;
  (_a5 = __privateGet(this, _listeners))[type] ?? (_a5[type] = []);
  if (insertMode === "prepend") {
    __privateGet(this, _listeners)[type].unshift(listener);
  } else {
...
}, callListener_fn = function(event, listener) {
  var _a5;
  const returnValue = listener.call(this, event);
  if ((_a5 = listener[kListenerOptions]) == null ? void 0 : _a5.once) {
    this.removeListener(event.type, listener);
  }
  return returnValue;
}, _a3);
var SUPPORTS_SERVICE_WORKER = supportsServiceWorker();
var _workerEvent, _a4;
var WorkerEvent = (_a4 = class extends TypedEvent {
  constructor(workerEvent) {
    ...
    __privateAdd(this, _workerEvent);
    __privateSet(this, _workerEvent, workerEvent);
  }
  get ports() {
    return __privateGet(this, _workerEvent).ports;
  }
  /**
   * Reply directly to this event using its `MessagePort`.
   */
  postMessage(type, ...rest) {
    __privateGet(this, _workerEvent).ports[0].postMessage(
      { type, data: rest[0] },
      { transfer: rest[1] }
    );
  }
}, _workerEvent = new WeakMap(), _a4);
      ...
      methodCall: ([methodName, args], invoke) => {
        switch (methodName) {
          ...
          case "send": {
            ...
            queueMicrotask(() => {
              var _a5;
              const onceRequestSettled = ((_a5 = this.onRequest) == null ? void 0 : _a5.call(this, {
                request: fetchRequest,
                requestId: this.requestId
              })) || Promise.resolve();
...
var SetupWorkerApi = class extends SetupApi {
  ...
  stop() {
    ...
    window.postMessage({ type: "msw/worker:stop" });
    printStopMessage({
      quiet: (_a5 = this.context.startOptions) == null ? void 0 : _a5.quiet
    });
  }
};
